...
const siteData = {
  business: {
    name: "Nharadada Hardware",
    legalName: "Nharadada Hardware",
    tagline: "Quality Building Materials & Hardware Supplies",
    description: "Nharadada Hardware has been serving Harare's builders, contractors, and homeowners with quality building materials and hardware supplies for over a decade.",
    phone: "+263 77 295 4540",
    phoneRaw: "+263772954540",
    whatsappNumber: "263772954540",
    email: "info@nharadadahardware.co.zw",
    address: "523V+895, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 3.3,
    ratingRounded: 3,
    ...
    cookieConsentKey: "nharadada-hardware-cookie-consent",
    socialLinks: { facebook: "https://m.facebook.com/100047318444035/photos/1158069109113693/", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Nharadada", logoLine2: "Hardware" },
  ...
  homeTestimonials: [
    { text: "Nharadada Hardware has been our go-to hardware supplier for three years. Consistent quality, fair pricing, and they always have stock when others do not.", name: "Blessing Chakandinakira", role: "Building Contractor", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    ...
    { text: "Bulk delivery is always on time and the prices are competitive. Nharadada Hardware is the only hardware store I recommend to my clients.", name: "Farai Mukwashi", role: "Architect", rating: 5, avatar: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Nharadada Hardware has been serving Harare's builders, contractors, and homeowners with quality building materials and hardware supplies for over a decade.",
  ...
  reviews: {
    ...
    items: [
      { text: "Nharadada Hardware has been our go-to hardware supplier for three years. Consistent quality, fair pricing, and they always have stock when others do not.", name: "Blessing Chakandinakira", role: "Building Contractor", rating: 5 },
      ...
      { text: "Bulk delivery is always on time and the prices are competitive. Nharadada Hardware is the only hardware store I recommend to my clients.", name: "Farai Mukwashi", role: "Architect", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. Nharadada Hardware exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend Nharadada Hardware to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at Nharadada Hardware is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. Nharadada Hardware has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi Nharadada Hardware! I would like to request a quote.",
